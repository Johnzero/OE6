...
class crm_lead(crm_case, osv.osv):
    ...
    def read_group_stage_ids(self,cr, uid, ids, domain, read_group_order=None, access_rights_uid=None, context=None):
    ...
    def compute_day(self, cr, uid, ids, fields, args=None, context=None):
        """
    ...
    _columns = {
        ...
        'day_open': fields.function(compute_day, string='Days to Open', \
                                multi='day_open', type="float", store=True),
        'day_close': fields.function(compute_day, string='Days to Close', \
    ...
    def onchange_partner_address_id(self, cr, uid, ids,name, email=False):
        """This function returns value of partner email based on Partner Address
        """
        if not name:
            return {'value': {'email_from': False, 'country_id': False}}
        address = self.pool.get('res.partner.address').browse(cr, uid, name)
    ...
    def case_open(self, cr, uid, ids, *args):
        for l in self.browse(cr, uid, ids):
            ...
            if l.state == 'draft':
                ...
                value = {'date_open': time.strftime('%Y-%d-%m %H:%M:%S')}
    ...
    def case_close(self, cr, uid, ids, *args):
        ...
        self.write(cr, uid, ids, {'date_closed': time.strftime('%Y-%d-%m %H:%M:%S')})
